...
public:
    void register_class_representation(std::string_view class_name,
...
private:
    ...
    std::unordered_map<std::string_view, ClassDispTableRepresentation>
        representations;
